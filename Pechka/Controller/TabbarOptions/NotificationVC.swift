...
func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        {
            let cell = tbleView.dequeueReusableCell(withIdentifier: "NotificationTableViewCell") as! NotificationTableViewCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
      ...
      else
      {
        ...
        objRef.checkScreen = "Notification Detail"
...
//        let params: [String: Any] = ["user_id":userIdStr,"device_token":"sdgfasdgasgfgaf"]
//        
//        print(params);
//        
//        WebService.shared.apiPostClient(url: BaseViewController.API_URL+"rest/noti_messages/all_notis/api_key/teampsisthebest/limit/30/offset/0", parameters: params) { (response, error) in
//        if error == nil{
//            
    ...
    func getNotificationsApi()
     {
      ...
      Alamofire.request(BaseViewController.API_URL+"rest/noti_messages/all_notis/api_key/teampsisthebest/limit/30/offset/0", method: .post , parameters: params,headers:headers1).responseJSON{ response in
        self.objHudHide();
            switch response.result {

            case .success (let value):
                APPDELEGATE.getNotificationList.removeAllObjects()
                if let array = response.result.value as? [Any] {
                    ...
                    for i in 0..<resultsArray.count
                    {
                        ...
                        APPDELEGATE.getNotificationList.insert(resultsArray[i], at:  APPDELEGATE.getNotificationList.count)
                    }
                }
                ...
                print(APPDELEGATE.getNotificationList)
