...
class WishListVC: BaseViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        {
            let arr = convertToDictionary(text: "\(object)") as? NSArray
            for i in 0..<arr!.count {
                ...
                ArrHistory.insert(dict, at: ArrHistory.count)
        }
        }
        
//        if ArrHistory.count != 0
//        {
//            for i in 0..<ArrHistory.count{
//                for j in 0..<APPDELEGATE.getAllHistryItems.count {
//                    
//                        if let tempDic1 : Dictionary = ArrHistory[i] as? Dictionary<String,Any>
//                         {
//                            if let getId1 : String = tempDic1["id"] as? String
//                            {
//                                if let tempDic2 : Dictionary = APPDELEGATE.getAllHistryItems[j] as? Dictionary<String,Any>
//                                 {
//                                    if let getId2 : String = tempDic2["id"] as? String
//                                    {
//                                        if getId1 == getId2 {
//                                            APPDELEGATE.getAllHistryItems.remove(ArrHistory[i])
//                                        }
//                                    }
//                                }
//                            }
...
//      
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print("History:\(APPDELEGATE.getAllHistryItems)")
    ...
    @IBAction func action_sideHideMenuBtnTapped(_ sender: UIButton)
    {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int
    {
        if tableView == tbleView
        {
        return APPDELEGATE.getAllHistryItems.count
        }
        else
        {
            if section == 0
...
func tableView(_ tableView: UITableView, willDisplayHeaderView view: UIView, forSection section: Int)
{
  view.tintColor = .clear
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        if let tempDic1 : Dictionary = APPDELEGATE.getAllHistryItems[indexPath.row] as? Dictionary<String,Any>
         {
            if let getCatName : String = tempDic1["title"] as? String
            {
                cell.lblTitle.text = getCatName
            }
            if let getCatNameDate : String = tempDic1["added_date"] as? String
            {
                cell.lblPrice.text = getCatNameDate
            }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        if tableView == tbleView
        {
            ...
            objRef.checkScreen = "UserHistory"
            self.navigationController?.pushViewController(objRef, animated: true)
        }
        else
        {
