...
class PrivacyPolicyVC: BaseViewController,UITableViewDelegate,UITableViewDataSource,UITextViewDelegate
{
               ...
               APPDELEGATE.getAboutUs.removeAllObjects()
                if let array = response.result.value as? [Any] {
                    ...
                    if let tempDic1 : Dictionary = APPDELEGATE.getAboutUs[0] as? Dictionary<String,Any>
                     {
                        if let getSliderNameImg : String = tempDic1["privacypolicy"] as? String
                        {
                            let newString = getSliderNameImg.replacingOccurrences(of: "<p>", with: "", options: .literal, range: nil)
                            let newString2 = newString.replacingOccurrences(of: "</p>", with: "", options: .literal, range: nil)
                            let newString3 = newString2.replacingOccurrences(of: "<strong>", with: "", options: .literal, range: nil)
                            let newString4 = newString3.replacingOccurrences(of: "</strong>", with: "", options: .literal, range: nil)
                            let newString5 = newString4.replacingOccurrences(of: "<u>", with: "", options: .literal, range: nil)
                            let newString6 = newString5.replacingOccurrences(of: "</u>", with: "", options: .literal, range: nil)
                            self.txtView.text = newString6
                        }
                    }
